...
class LED():
    def __init__(self, LED_COUNT = 64, LED_PIN = 18, LED_FREQ_HZ = 800000, LED_DMA = 10, LED_BRIGHTNESS = 255, LED_INVERT = False, LED_CHANNEL = 0):# Create NeoPixel object with appropriate configuration.
